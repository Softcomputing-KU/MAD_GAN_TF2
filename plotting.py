...
def save_samples_generated(samples, identifier):
    """
    Save generated samples to a file.
    
    Args:
        samples: Generated samples to save
        identifier: Unique identifier for the saved file
    """
    import numpy as np
    save_path = f'./experiments/plots/gs/{identifier}_generated_samples.npy'
